...
public static class globals
{
    ...
    public static string PATH_DB = Application.persistentDataPath + "/Database/";
    public static string FILENAME_DB = "/game.db";
    ...
    public static string TAG_UI_HIT_EFFECTS_OBJECT = "HitEffects";
    ...
    public static string GAMEOBJECT_LOADING_PANEL = "LoadingPanel";
